...
// ---    Mon Dec 05 17:09:27 IST 2022
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class SgsCostTargetCombinationEOImpl extends EntityImpl {
    ...
    public static final int TARGETBUSINESSUNIT = AttributesEnum.TargetBusinessUnit.index();
    public static final int TARGETOPERATINGUNIT = AttributesEnum.TargetOperatingUnit.index();
    public static final int TARGETJOBCODE = AttributesEnum.TargetJobCode.index();
    public static final int TARGETGLACCOUNT = AttributesEnum.TargetGlAccount.index();
    ...
    public static final int TARGETDEPTID = AttributesEnum.TARGETDEPTID.index();
    ...
    /**
     * Gets the attribute value for TargetBusinessUnit, using the alias name TargetBusinessUnit.
     * @return the value of TargetBusinessUnit
     */
    public String getTargetBusinessUnit() {
        return (String) getAttributeInternal(TARGETBUSINESSUNIT);
    }

    /**
     * Sets <code>value</code> as the attribute value for TargetBusinessUnit.
     * @param value value to set the TargetBusinessUnit
     */
    public void setTargetBusinessUnit(String value) {
        setAttributeInternal(TARGETBUSINESSUNIT, value);
    }

    /**
     * Gets the attribute value for TargetOperatingUnit, using the alias name TargetOperatingUnit.
     * @return the value of TargetOperatingUnit
     */
    public String getTargetOperatingUnit() {
        return (String) getAttributeInternal(TARGETOPERATINGUNIT);
    }

    /**
     * Sets <code>value</code> as the attribute value for TargetOperatingUnit.
     * @param value value to set the TargetOperatingUnit
     */
    public void setTargetOperatingUnit(String value) {
        setAttributeInternal(TARGETOPERATINGUNIT, value);
    }
     ...
     */
    public String getTargetJobCode() {
        return (String) getAttributeInternal(TARGETJOBCODE);
    }
     ...
     */
    public void setTargetJobCode(String value) {
        setAttributeInternal(TARGETJOBCODE, value);
    }

    /**
     * Gets the attribute value for TargetGlAccount, using the alias name TargetGlAccount.
     * @return the value of TargetGlAccount
     */
    public String getTargetGlAccount() {
        return (String) getAttributeInternal(TARGETGLACCOUNT);
    }

    /**
     * Sets <code>value</code> as the attribute value for TargetGlAccount.
     * @param value value to set the TargetGlAccount
     */
    public void setTargetGlAccount(String value) {
        setAttributeInternal(TARGETGLACCOUNT, value);
    }
    ...
    /**
     * Gets the attribute value for TARGETDEPTID, using the alias name TARGETDEPTID.
     * @return the value of TARGETDEPTID
     */
    public String getTARGETDEPTID() {
        return (String) getAttributeInternal(TARGETDEPTID);
    }

    /**
     * Sets <code>value</code> as the attribute value for TARGETDEPTID.
     * @param value value to set the TARGETDEPTID
     */
    public void setTARGETDEPTID(String value) {
        setAttributeInternal(TARGETDEPTID, value);
    }
