...
// ---    Mon Mar 06 12:01:30 IST 2023
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class SgsPstTxnDocAttachmentEOImpl extends EntityImpl {
    /**
    ...
    private static final ADFLogger LOG = ADFLogger.createADFLogger(SgsPstTxnDocAttachmentEOImpl.class);
     ...
     */
    public SgsPstTxnDocAttachmentEOImpl() {
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("com.sgs.ics.model.bc.entity.SgsPstTxnDocAttachmentEO");
    }

    /**
     * Gets the attribute value for TransId, using the alias name TransId.
     * @return the value of TransId
     */
    public String getTransId() {
        return (String) getAttributeInternal(TRANSID);
    }

    /**
     * Sets <code>value</code> as the attribute value for TransId.
    ...
    protected void create(AttributeList attributeList) {
        ...
        try {
            ...
            setDocTypeId(am.getDBSequence1("SEQ_SGS_PST_TXN_DOC_ATTACHMENT"));
