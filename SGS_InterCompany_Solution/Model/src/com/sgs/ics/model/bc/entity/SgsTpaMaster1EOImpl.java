...
public class SgsTpaMaster1EOImpl extends EntityImpl {
    ...
    public static final int SGSTPADOCATTACHMENT1EO = AttributesEnum.SgsTpaDocAttachment1EO.index();
     ...
     */
    public RowIterator getSgsTpaDocAttachment1EO() {
        return (RowIterator) getAttributeInternal(SGSTPADOCATTACHMENT1EO);
    }
